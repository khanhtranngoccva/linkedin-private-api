...
*Defined in [src/entities/linkedin-image-view-model.entity.ts:4](https://github.com/khanhtranngoccva/linkedin-private-api/blob/b1cbdad/src/entities/linkedin-image-view-model.entity.ts#L4)*
...
*Defined in [src/entities/linkedin-image-view-model.entity.ts:5](https://github.com/khanhtranngoccva/linkedin-private-api/blob/b1cbdad/src/entities/linkedin-image-view-model.entity.ts#L5)*
