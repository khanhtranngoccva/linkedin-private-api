...
*Defined in [src/entities/message-event.entity.ts:6](https://github.com/khanhtranngoccva/linkedin-private-api/blob/e33dfd5/src/entities/message-event.entity.ts#L6)*
...
*Defined in [src/entities/message-event.entity.ts:5](https://github.com/khanhtranngoccva/linkedin-private-api/blob/e33dfd5/src/entities/message-event.entity.ts#L5)*
