...
*Defined in [src/entities/linkedin-message-event.entity.ts:6](https://github.com/khanhtranngoccva/linkedin-private-api/blob/355192d/src/entities/linkedin-message-event.entity.ts#L6)*
...
*Defined in [src/entities/linkedin-message-event.entity.ts:7](https://github.com/khanhtranngoccva/linkedin-private-api/blob/355192d/src/entities/linkedin-message-event.entity.ts#L7)*
...
*Defined in [src/entities/message-event.entity.ts:6](https://github.com/khanhtranngoccva/linkedin-private-api/blob/355192d/src/entities/message-event.entity.ts#L6)*
...
*Defined in [src/entities/message-event.entity.ts:5](https://github.com/khanhtranngoccva/linkedin-private-api/blob/355192d/src/entities/message-event.entity.ts#L5)*
