...
*Defined in [src/entities/message-create-response.entity.ts:4](https://github.com/khanhtranngoccva/linkedin-private-api/blob/a63729e/src/entities/message-create-response.entity.ts#L4)*
