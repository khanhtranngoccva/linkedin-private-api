...
*Defined in [src/scrollers/message.scroller.ts:20](https://github.com/khanhtranngoccva/linkedin-private-api/blob/17c022a/src/scrollers/message.scroller.ts#L20)*
...
*Defined in [src/scrollers/message.scroller.ts:37](https://github.com/khanhtranngoccva/linkedin-private-api/blob/17c022a/src/scrollers/message.scroller.ts#L37)*
