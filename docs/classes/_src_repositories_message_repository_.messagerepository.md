...
*Defined in [src/repositories/message.repository.ts:18](https://github.com/khanhtranngoccva/linkedin-private-api/blob/355192d/src/repositories/message.repository.ts#L18)*
...
*Defined in [src/repositories/message.repository.ts:24](https://github.com/khanhtranngoccva/linkedin-private-api/blob/355192d/src/repositories/message.repository.ts#L24)*
...
*Defined in [src/repositories/message.repository.ts:28](https://github.com/khanhtranngoccva/linkedin-private-api/blob/355192d/src/repositories/message.repository.ts#L28)*
