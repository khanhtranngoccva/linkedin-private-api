...
*Defined in [src/entities/linkedin-event.entity.ts:1](https://github.com/khanhtranngoccva/linkedin-private-api/blob/17c022a/src/entities/linkedin-event.entity.ts#L1)*
...
*Defined in [src/entities/linkedin-event.entity.ts:3](https://github.com/khanhtranngoccva/linkedin-private-api/blob/17c022a/src/entities/linkedin-event.entity.ts#L3)*
