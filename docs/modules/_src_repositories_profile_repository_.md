...
*Defined in [src/repositories/profile.repository.ts:20](https://github.com/khanhtranngoccva/linkedin-private-api/blob/355192d/src/repositories/profile.repository.ts#L20)*
